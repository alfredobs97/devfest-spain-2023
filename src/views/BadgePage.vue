      ...
      <v-row>
        <v-col md="12" lg="12" class="d-block d-sm-block d-md-none px-0">
          ...
          <p class="my-0 mb-8 h1-subheading google-font">
            Ahora que estás aquí, ¿qué tal si personalizas tu DevFest Spain?
            ¿Perfil 2023? Sube una imagen y genera una insignia personalizada con
            el marco de DevFest Spain 2023. También comparte tu imagen usando
            #DevFestSpain en diferentes plataformas sociales.
          </p>
        </v-col>
      </v-row>
      <!-- Mobile -->
        ...
        >
          <div class="d-none d-sm-none d-md-block mb-10">
            ...
            <p class="google-font" style="font-size: 18px">
              Ahora que estás aquí, ¿Qué tal si personalizas tu Perfil? Sube una imagen y genera una insignia personalizada con
            el marco de DevFest Spain 2023. También comparte tu imagen usando
            #DevFestSpain2023 en diferentes plataformas sociales.
            </p>
          </div>
          <div class="input">
